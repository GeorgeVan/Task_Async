...
namespace DataflowBatchDatabase
{
    class Program
    {
        ...
        static readonly string sourceDatabase =
           @"C:\Users\George\Documents\db\Northwind.sdf";
        ...
        class Employee
        {
            ...
            static int employeeIDStart = 100;
               ...
               new SqlCeConnection(connectionString))
            {
                try
                {
                    ...
                    for (int i = 0; i < employees.Length; i++)
                    {
                        ...
                        command.Parameters.Add("@EmployeeID", employees[i].EmployeeID);
